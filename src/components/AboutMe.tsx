          ...
          <div className='mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8'>
            <div className='mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1'>
              <p className='text-md leading-8 text-gray-600'>
                ...
                development, where I wield TypeScript and JavaScript to breathe
                life into clean and beautiful user interfaces. Witnessing
                creations come to life is what fuels my passion.
              </p>
              <p className='text-md leading-8 text-gray-600'>
              ...
              <p className='text-md leading-8 text-gray-600'>
                ...
                things on the computer using HTML/CSS. Although a chapter of my
                life led me to pursue a degree in Biology, my love for tech
                ultimately beckoned me back to the captivating world of software
                engineering.
              </p>
            </div>

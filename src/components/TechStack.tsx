...
const stats = [
  ...
  { id: 7, name: 'Nextjs', value: '/Icons/Nextjs.svg' },
  { id: 8, name: 'Node', value: '/Icons/Node.svg' },
  { id: 9, name: 'Postgres', value: '/Icons/Postgres.svg' },
  { id: 10, name: 'MongoDB', value: '/Icons/MongoDB.svg' },
  { id: 11, name: 'TailwindCss', value: '/Icons/Tailwindcss.svg' },
  { id: 12, name: 'Jest', value: '/Icons/Jest.svg' },
];
